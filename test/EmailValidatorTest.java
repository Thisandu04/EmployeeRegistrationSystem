...
class EmailValidatorTest {
    ...
    void isValidEmail() {
        ...
        assertFalse(emailValidator.isValidEmail("@example.com"),"Empty email should file");
    ...
    void isCompanyEmail() {
       ...
       assertTrue(emailValidator.isCompanyEmail("employee@company.com"),"valid email should pass");
        assertFalse(emailValidator.isCompanyEmail("employee@company.com"),"email with the wrong domain(employee@company.com)");
